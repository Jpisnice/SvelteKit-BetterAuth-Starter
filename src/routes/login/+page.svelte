<script lang="ts">
    ...
    <div class="flex justify-center items-center min-h-screen bg-gray-100">
        <div class="p-8 bg-white rounded-lg shadow-md">
            ...
            {:else}
                <button
                    class="flex items-center px-6 py-3 bg-gray-900 text-white rounded-md hover:bg-gray-800 transition-colors"
                    onclick={async () => {
                ...
                <br/>
                <button
                    class="flex items-center px-6 py-3 bg-green-500 text-white rounded-md hover:bg-green-400 transition-colors"
                    onclick={async () => {
                        await authClient.signIn.social({
                            provider: "google",
                            callbackURL: "http://localhost:5173/login",
